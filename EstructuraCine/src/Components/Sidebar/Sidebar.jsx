...
const customtema = {
    "root": {
        ...
        "inner": "h-full overflow-y-auto overflow-x-hidden rounded bg-agua py-4 px-3 dark:bg-black"
    },
    "collapse": {
  ...
  return (
    ...
    >
      <FlowbiteSidebar aria-label="Menu de Cine" theme={customtema} >
        ...
        <FlowbiteSidebar.Item href="#" icon={HiUser} className= 'hover:text-black'>
          Perfil
        </FlowbiteSidebar.Item>
        <FlowbiteSidebar.Item href="#" icon={HiTicket}className= 'hover:text-black'>
          Tiquetes
        </FlowbiteSidebar.Item>
        <FlowbiteSidebar.Item href="#" icon={HiShoppingCart}className= 'hover:text-black'>
          Carrito
        </FlowbiteSidebar.Item>
      </FlowbiteSidebar.ItemGroup>
      <FlowbiteSidebar.ItemGroup>
        <FlowbiteSidebar.Item href="#" icon={HiOutlineChatAlt2 }className= 'hover:text-black'>
          Mensajes
        </FlowbiteSidebar.Item>
      </FlowbiteSidebar.ItemGroup>
        </FlowbiteSidebar.Items>
