  ...
  return (
    <div className="sm:flex-col-reverse">
      <div className="flex mr-5 ml-32 text-white p-5 rounded-md h-full ">
        <img className="movie-poster sm:w-60 md:w-32 sm:h-1 xl:w-1/2 xl:h-1/3 2xl:w-2/5 2xl:mr-32 2xl:ml-28 mr-20 ml-3 rounded-2xl" src={movie.imageUrl} alt="Imagen" />
