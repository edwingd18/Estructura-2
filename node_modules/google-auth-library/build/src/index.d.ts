...
export { Certificates, CodeChallengeMethod, CodeVerifierResults, GenerateAuthUrlOpts, GetTokenOptions, OAuth2Client, OAuth2ClientOptions, RefreshOptions, TokenInfo, VerifyIdTokenOptions, } from 'google-auth-library/build/src/auth/oauth2client';
...
export { AwsClient, AwsClientOptions } from 'google-auth-library/build/src/auth/awsclient';
export { IdentityPoolClient, IdentityPoolClientOptions, } from 'google-auth-library/build/src/auth/identitypoolclient';
export { ExternalAccountClient, ExternalAccountClientOptions, } from 'google-auth-library/build/src/auth/externalclient';
export { BaseExternalAccountClient, BaseExternalAccountClientOptions, } from 'google-auth-library/build/src/auth/baseexternalclient';
export { CredentialAccessBoundary, DownscopedClient, } from 'google-auth-library/build/src/auth/downscopedclient';
export { PluggableAuthClient, PluggableAuthClientOptions, } from 'google-auth-library/build/src/auth/pluggable-auth-client';
